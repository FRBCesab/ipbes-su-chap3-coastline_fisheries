...
map_frame <- function(xmin = -180, xmax = 180, ymin = -90, ymax = 90, 
                      crs = NA) {
...
map_graticules <- function(xmin = -180, xmax = 180, ymin = -90, ymax = 90, 
                           meridians = seq(-180, 180, 60), 
                           parallels = seq( -60,  60, 20), crs = NA) {
...
map_axes <- function(xmin = -180, xmax = 180, ymin = -90, ymax = 90, 
                     meridians = seq(-180, 180, 60), 
                     parallels = seq( -60,  60, 20), crs = NA) {
